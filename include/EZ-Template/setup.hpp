...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {-4, 5, -6}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {3, 17, -16}; // Ports, the first number will be used for sensing
